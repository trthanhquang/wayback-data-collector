...
class Snapshot(object):
    ...
    def compareHTML(self, other, mode = 'offline'):
        ...
        if mode == 'online':
            f.write('<li> <a href=\"%s\">HTML1 (CURRENT)</a> </li>'%self.getURL())
            f.write('<li> <a href=\"%s\">HTML2 (OTHER)</a> </li>'%other.getURL())
        else:
            f.write('<li> <a href=\"file:///{}\">HTML1(CURRENT)</a> </li>'.format(path+"\\"+'html1.html'))
            f.write('<li> <a href=\"file:///{}\">HTML2(OTHER)</a> </li>'.format(path+"\\"+'html2.html'))

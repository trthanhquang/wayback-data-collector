...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2014 at 03:46 AM
...
(PARTITION p0 VALUES LESS THAN (3620) ENGINE = MyISAM,
 PARTITION p1 VALUES LESS THAN (3846) ENGINE = MyISAM,
 PARTITION p2 VALUES LESS THAN (4072) ENGINE = MyISAM,
 PARTITION p3 VALUES LESS THAN (4297) ENGINE = MyISAM,
 PARTITION p4 VALUES LESS THAN (4524) ENGINE = MyISAM) */;
